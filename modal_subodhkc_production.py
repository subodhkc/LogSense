"""
LogSense Production Deployment for subodhkc Modal Account
Canonical entry point: https://subodhkc--logsense-production-web-app.modal.run
"""
import modal
import os
import sys
...
if __name__ == "__main__":
    ...
    print(f"Expected URL: https://subodhkc--{APP_NAME}-{FUNCTION_NAME.replace('_', '-')}.modal.run")
